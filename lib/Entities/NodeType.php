...
class NodeType extends AbstractRepositoryEntity
{
	...
	public function createAssociation($friendlyName, $assocTypeQName, $associatedTypeQName)
	{
		$associated_type = $associated_type = $this->getRepository()->getNodeTypeService()->getNodeTypeByTypeQName($associatedTypeQName);
		$this->getRepository()->getNodeTypeService()->createAssociation($friendlyName, $assocTypeQName, $this, $associated_type);
	}
